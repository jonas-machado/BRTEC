...
const Nav = ({ classname }: { classname: string }) => {
  ...
  return (
    <div className="flex items-center shadow-2xl shadow-black">
      <div
        className={`flex bg-gray-800 items-center pr-0 h-10 p-4 pl-0 bg-opacity-90 shadow-md shadow-black`}
      >
        <Link
          href={home.link}
      ...
      <div className="border-gray-800 m-[-0.2px] opacity-90 border-l-[25px] border-t-transparent border-t-[21px] border-b-transparent border-b-[21px] w-0 h-0"></div>
    </div>
  );
};
